...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div id="mydownload">
        ...
        <ul>
            <li>【Software】&nbsp; <a href="down/LockingSystem5.1.rar">Locking System 5.1 (c mifare usb port)</a></li>
            <li>【Software】&nbsp; <a href="down/ic%20card%20lock%203.1.rar">IC card locking system v3.1 (usb port)</a></li>
            <li>【Software】&nbsp; <a href="down/orbita_rf_locking_3.4.2.rar">RF card locking system v3.4.2 (usb port, 32bit encoder)</a></li>
			<li>【Software】&nbsp; <a href="down/Orbita.RF.Locking.3.4.3.rar">RF card locking system v3.4.3 (usb port, 64bit encoder)</a></li>
